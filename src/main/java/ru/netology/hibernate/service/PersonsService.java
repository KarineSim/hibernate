...
public class PersonsService {
    ...
    public Persons update(PersonsPrimaryKey personsPrimaryKey, Persons person) {
        ...
        if (updatePerson.isPresent()) {
            updatePerson.get().getPersonsPrimaryKey().setName(person.getPersonsPrimaryKey().getName());
            updatePerson.get().getPersonsPrimaryKey().setSurname(person.getPersonsPrimaryKey().getSurname());
            updatePerson.get().getPersonsPrimaryKey().setAge(person.getPersonsPrimaryKey().getAge());
